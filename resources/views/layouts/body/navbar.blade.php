<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        {{-- Contenu principal de la barre de navigation (liens de menu) --}}
        <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="navbar">
                <div class="container-xl">
                    <ul class="navbar-nav">
                        {{-- Tableau de bord (visible pour tous les utilisateurs ayant accès à une entreprise) --}}
                        <li class="nav-item {{ request()->is('dashboard*', 'company-dashboard*') ? 'active' : null }}">
                        ...
                        {{-- Commandes --}}
                        {{-- Affiche le menu "Commandes" si l'utilisateur a au moins une des permissions liées aux commandes --}}
                        @canany(['create-order', 'view-orders', 'edit-order'])
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        ...
                                        @can('create-purchase') {{-- Assurez-vous d'avoir cette permission --}}
                        ...
                        {{-- Pages (Fournisseurs, Clients) --}}
                        @canany(['manage-suppliers', 'manage-customers'])
                        ...
                        {{-- Paramètres (Utilisateurs, Catégories, Unités) --}}
                        @canany(['manage-users-per-company', 'manage-categories', 'manage-units'])
                        ...
                        {{-- Menu Entreprise (visible pour tous les admin_principal) --}}
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        ...
                                        @endauth
                                        <a class="dropdown-item" href="{{ route('manage.companies.create') }}">
                                            {{ __('Créer une nouvelle entreprise') }}
                                        </a>
                                        <a class="dropdown-item" href="{{ route('manage.companies.index') }}">
