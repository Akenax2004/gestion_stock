...
{{--                                            @foreach ($orderDetails as $item)--}}
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    {{ Number::currency($item->unitcost, 'XOF') }}
                                                </td>
                                                <td class="align-middle text-center">
                                                    {{ $item->quantity }}
                                                </td>
                                                <td class="align-middle text-center">
                                                    {{ Number::currency($item->total, 'XOF') }}
                                                </td>
                                            </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <strong>
                                                        {{ Number::currency($order->sub_total, 'XOF') }}
                                                    </strong>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <strong>
                                                        {{ Number::currency($order->total, 'XOF') }}
                                                    </strong>
                                                </td>
                                            </tr>
                                        </tbody>
